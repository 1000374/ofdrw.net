...
See [docs/capability-roadmap.md](docs/capability-roadmap.md) for the TODO list,
implementation batches, and the encryption/signature boundary without a crypto vendor.
